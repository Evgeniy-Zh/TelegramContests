...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        float ax = avatarContainer.getX() + insetMain * avatarContainer.getScaleX() + (avatarContainer.getWidth() / 2f * (1f - avatarContainer.getScaleX())); //TODO: broken for the old profile
